...
9/17 & 4: $A\mathbf{x} =\mathbf{b}$   & 1.4, 1.5, 1.6 & H3 & H2 \\ % Include population movement example from 1.10 
\hline

%  Lay 1.7, 1.8, 1.9
9/22 & 5: Linear Independence  & 1.7 1.8 & & \\
9/24 & 6: Linear Transformations  (Guest Lecture) &  1.8 & H4 & H3\\ 
\hline
...
10/8 &9: Markov Chains  &4.9 & & H5 \\ % include the electrical circuit example 
\hline
...
% Lay 5.2, 5.3
11/10 & 16: Diagonalization  & 5.3, 5.4 &  &\\  % Applications of eigen: markov, pagerank (exercises from 4.9)
