...
repository is
\texttt{https://github.com/mcrovella/CS132-Geometric-Algorithms}.  Mr.\ Bai
...
\begin{description}
\item[60\%] Homework assignments: 60\%  The top 10 homework grades (out of the
...
\textbf{IMPORTANT:} The best strategy is to do the reading \emph{before} the class on
