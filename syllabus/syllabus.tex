...
%  Lay 1.7, 1.8, 1.9
2/10 & SNOW DAY & & & H3 \\
2/12 & 5: Linear Independence & 1.7 1.8 & H4 & \\ % Include population movement example from 1.10
\hline
...
% Lay 4.1, 4.2
% Applications: Population Movement from 1.10
3/3 & 9: Applications & 1.10, 2.6 & & H6 \\  
3/5 & 10: Matrix Factorizations & 2.5 & & \\ % include the electrical circuit example
\hline
