...
9/17 & 5: Linear Independence & 1.7 1.8 & H3 & H2 \\ % Include population movement example from 1.10 
\hline
...
10/15 & 10: Matrix Factorizations & 2.5 & & \\ % include the electrical circuit example 
\hline
...
11/12 & 17: PageRank & notes only & H10 &\\  % Applications of eigen: markov, pagerank (exercises from 4.9)
\hline
