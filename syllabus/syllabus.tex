...
%  Lay 1.7, 1.8, 1.9
2/10 & 5: Linear Independence & 1.7 & & H3 \\
2/12 & 6: Linear Transformations & 1.8 & H4 & \\ % Include population movement example from 1.10
\hline

% Lay 2.1
2/17 & Substitute Monday - NO CLASS & & &\\
2/19 & 7: The Matrix of a Linear Transform  & 1.9 & H5 & H4 \\
\hline

%  Lay 2.2, 2.3
2/24 & 8: Matrix Operations  & 2.1 & & H5\\ 
2/26 & 9: Matrix Inverse & 2.2 & H6 &\\ 
\hline

% Lay 4.1, 4.2
3/3 & 10:  Invertible Matrices & 2.3 & & H6 \\ 
3/5 & 11:  Matrix Factorizations & 2.5 & & \\ 
\hline
...
% Lay 4.3
3/17 & Midterm & & &\\
3/19 & 12: Computer Graphics & 2.7 & H7 &\\ 
\hline
...
% Lay 6.1, 6.2
4/14 & 19: Applications of Eigendecomposition & 4.9, 10.2 & & H10\\ % Applications of eigen: markov, pagerank (exercises from 4.9)
